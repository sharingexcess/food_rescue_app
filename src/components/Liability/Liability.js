        ...
        <ul>
          ...
          <li>
            <Text type="paragraph">
              ...
              insurance coverage, which will be primary in the event I am
          ...
          <li>
            <Text type="paragraph">
              Pay any and all traffic violations, including parking tickets,
              that I may receive during my services for Sharing Excess
            </Text>
          </li>
        </ul>
